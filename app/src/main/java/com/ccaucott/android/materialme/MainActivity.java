...
public class MainActivity extends AppCompatActivity {
    ...
    private void initializeData() {
        ...
        String[] sportsColorThemes = getResources().getStringArray(R.array.sport_color_themes);
        ...
        for(int i=0;i<sportsList.length;i++){
            mSportsData.add(new Sport(sportsList[i],sportsInfo[i], sportsImageResources.getResourceId(i, 0), sportsColorThemes[i]));
        }

        // Clear up the data in the typed array.
